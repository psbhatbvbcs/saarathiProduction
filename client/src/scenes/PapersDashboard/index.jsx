...
const PapersDashboard = () => {
    ...
    return (
        <StyledDashboard>
            <Title>Practice Question Papers</Title>
            ...
            <Box m={isNonMobile ? "3rem 2rem" : "3rem 0rem"} display={"flex"}>
                                            ...
                                            >
                                                {matchingSubjects?.map((subject) => (
                                                    <ListItem
                                                        ...
                                                        key={subject}
                                                    >
                                                        <ListItemButton sx={{ marginBottom: "5px", bgcolor: mode === "light" ? "wheat" : "rgba(0, 0, 0, 0.12)", borderRadius: "10px" }} onClick={() => navigate(`/papers/sem/${item}/${subject}`)}>
                                                            <ListItemIcon
                                                                sx={{
                                                                    minWidth: '20px',
